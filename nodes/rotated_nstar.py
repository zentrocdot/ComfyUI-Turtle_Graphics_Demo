...
# ************************************
# Class TurtleGraphicsRotatedNstarDemo
# ************************************
class TurtleGraphicsRotatedNstarDemo:
    ...
    def INPUT_TYPES(cls):
        ...
        return {
            "required": {
                "number_edges": ("INT", {"default": 5, "min": 5, "max": 1001}),
                ...
                "length": ("FLOAT", {"default": 205.0, "min": 0.0, "max": 360.0}),
    ...
    def demo(self, thickness, turtle_speed, turtle_shape, number_rotations,
            ...
            resize_sampler, remove_background, number_edges):
        ...
        try:
            ...
            # ------------------------------------
            star_ang = (360.0 / number_edges) * 2.0
            ts.left(start_angle)
    ...
    def turtle_graphics_main(self, thickness, turtle_speed, turtle_shape,
            ...
            angle, start_angle, resize_sampler, length, remove_background,
            number_edges):
